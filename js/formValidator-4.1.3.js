...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		$.ajax({async:false,type: "GET",url: themedir + "themes/"+settings.theme+"/theme.js",dataType: "script",
		...
		if($.browser.msie)
		{
			...
			css.rel="stylesheet";
			css.type="text/css";
			css.href=themedir+"themes/"+settings.theme+"/style.css";
		...
		else
		{
			...
			var styCss = "@import url('"+themedir+"themes/"+settings.theme+"/style.css');";
